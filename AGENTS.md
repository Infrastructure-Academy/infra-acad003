...
**MANDATORY:** Read `IAAI_SITE_REFERENCE.json` from workspace root BEFORE answering any question about IAAI sites, navigation, repositories, or status. Do not ask the user questions answered in that file.
