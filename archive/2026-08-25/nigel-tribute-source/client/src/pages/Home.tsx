          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
              ...
              <div className="w-full">
                ...
                <div className="p-3 flex items-center justify-center" style={{ border: `1px solid ${GOLD}44`, background: "rgba(212,168,67,0.04)" }}>
                  <img src={HICE_CARD} alt="HICE Classification — H=Holistic I=Innate C=Created E=Embodied" className="w-full object-contain cursor-pointer" style={{ maxHeight: "380px" }} onClick={() => setLightbox({ src: HICE_CARD, alt: "HICE Classification — Block 363" })} />
                </div>
